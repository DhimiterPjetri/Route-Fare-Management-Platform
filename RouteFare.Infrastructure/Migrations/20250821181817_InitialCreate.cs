        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_TourOperators_TourOperatorId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TourOperatorRouteId = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ModifiedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ModifiedBy = table.Column<string>(type: "nvarchar(max)", nullable: true)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Pricings_Routes_RouteId",
                        column: x => x.RouteId,
                        principalTable: "Routes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Pricings_Seasons_SeasonId",
                        column: x => x.SeasonId,
                        principalTable: "Seasons",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Pricings_TourOperatorRoutes_TourOperatorRouteId",
                        column: x => x.TourOperatorRouteId,
                        principalTable: "TourOperatorRoutes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Pricings_TourOperators_TourOperatorId",
                        column: x => x.TourOperatorId,
                        principalTable: "TourOperators",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.InsertData(
                ...
                {
                    { "1", null, "Admin", "ADMIN" },
                    { "2", null, "TourOperator", "TOUROPERATOR" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_TourOperatorId",
                table: "AspNetUsers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Pricings_RouteId",
                table: "Pricings",
                column: "RouteId");

            migrationBuilder.CreateIndex(
                name: "IX_Pricings_SeasonId",
                table: "Pricings",
                column: "SeasonId");

            migrationBuilder.CreateIndex(
                name: "IX_Pricings_TourOperatorId_RouteId_SeasonId_BookingClassId_Date",
                table: "Pricings",
                columns: new[] { "TourOperatorId", "RouteId", "SeasonId", "BookingClassId", "Date" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Pricings_TourOperatorRouteId",
                table: "Pricings",
                column: "TourOperatorRouteId");
